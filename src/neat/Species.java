...
public class Species {
    ...
    public boolean put(Client client){
        if (client.distance(representative) < representative.getGenome().getNeat().getMaxDistanceToSpecies()){
    ...
    public Genome breed(){
        ...
        if (c1.getGenome().getConnections().size() > c2.getGenome().getConnections().size())
        {
